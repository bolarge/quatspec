...
public class BankAccountApi {
    ...
    public BankAccountResource openSavingsAccount(@RequestBody BankAccountResource account) throws QuaspecServiceException {
        BankAccount bankAccount = (BankAccount) bankAccountService.createSavingsAccount(account);
        if (bankAccount != null) {
