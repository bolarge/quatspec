    ...
    <main class="mt-5">
        <div class="container">
            ...
            <section id="best-features" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Payspec Features</h2>
            ...
            <!--Section: Examples-->
            <section id="demonstrations" class="text-center">

                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Tailored Use Cases</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Rural</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima
                            assumenda deleniti hic.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Semi Urban</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima
                            assumenda deleniti hic.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Urban</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima
                            assumenda deleniti hic.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Agriculture & Raw Material</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima
                            assumenda deleniti hic.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Small & Medium Enterprises</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima
                            assumenda deleniti hic.</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <h4 class="my-4 font-weight-bold">Value Chain Producers & Services Providers</h4>
                        <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima
                            assumenda deleniti hic.</p>
            ...
            <section id="customers">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold text-center">What our customers are saying!!!</h2>
                    ...
                    <div class="col-lg-7 col-md-12">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-lg-4 col-md-12 mb-3">
                                ...
                                <p>
                                    <i class="fa fa-map fa-1x mr-2 grey-text"></i>Lekki Lagos, LG 105102</p>
                            ...
                            <div class="col-lg-4 col-md-6 mb-3">
                                ...
                                <p>
                                    <i class="fa fa-phone fa-1x mr-2 grey-text"></i>+ 234 081 869 5945</p>
