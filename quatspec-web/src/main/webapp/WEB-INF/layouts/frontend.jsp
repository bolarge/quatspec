...
<head>	
	...
	<link rel="stylesheet" type="text/css" media="screen" href="<c:url value='/static/css/style-frontend.css' />" />
...
<body>
	...
	<header>
		<tiles:insertAttribute name="frontend"/> 
	</header>
	...
	<footer>
		<tiles:insertAttribute name="bottom2" />
	</footer>
